"""
Django settings for raspy_fog_dev_111215 project.
...
ROOT_URLCONF = 'raspy_fog_dev_111215.urls'
...
WSGI_APPLICATION = 'raspy_fog_dev_111215.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_fog_dev_111215 API",
    "DESCRIPTION": "API documentation for raspy_fog_dev_111215 App",
    "VERSION": "v1",
}
